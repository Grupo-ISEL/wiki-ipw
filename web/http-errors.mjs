...
const HTTP_ERRORS_MAPPING = {
    ...
    4: HTTP_ERRORS.FORBIDDEN,
    5: HTTP_ERRORS.NOT_FOUND,
    6: HTTP_ERRORS.FORBIDDEN,
    7: HTTP_ERRORS.INTERNAL_SERVER_ERROR,
    8: HTTP_ERRORS.BAD_REQUEST,
    9: HTTP_ERRORS.UNAUTHORIZED,
    10: HTTP_ERRORS.BAD_REQUEST
